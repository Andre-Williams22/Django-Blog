...
SECRET_KEY='g=j!8z%m+18xyuc33xmz79528cpg0cjho!%0*84=&9(wp52-)k'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['localhost','machinelearningblog.herokuapp.com']
...
EMAIL_PORT = 587 
EMAIL_USE_TLS = True
EMAIL_HOST_USER=os.getenv('EMAIL_USER') # #os.getenv('EMAIL_USER') # config('EMAIL_USER')
...
django_heroku.settings(locals()) # this is for heroku deployment